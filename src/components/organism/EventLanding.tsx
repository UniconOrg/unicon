...
export default function EventLanding({ event }: EventLandingProps) {
  ...
  return (
    <section className="w-full bg-primary text-white">
      ...
      >
        ...
        {/* 2. Event content - título, descripción, CTA, countdown (antes que CTA en móvil) */}
        ...
        {/* 3. CTA Banner - después del contenido y countdown en móvil */}
